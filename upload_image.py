...
class Upload_img:
    def __init__(self):
        ...
        self.pic = Image.open('skills.png').convert("RGBA")
...
# ---- Water Mark Text Edit ---
    def water_mark_widgets(self):
        ...
        wm_text_apply_button.place(x=220, y=510, width=200)

        wm_img_save_button = Button(self.upload_window, text="Save image", bg="white", font=('Arial', 20, "bold"),
                                      fg="#BDCDD6", command=self.save_img)
        wm_img_save_button.place(x=220, y=540, width=200)
